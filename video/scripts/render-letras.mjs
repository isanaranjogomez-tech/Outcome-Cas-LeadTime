#!/usr/bin/env node
/**
 * Renders the MUNCAS letters round and masters its audio for social.
 *
 *   node scripts/render-letras.mjs
 *   node scripts/render-letras.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_LETRAS_FINAL_V4.raw.mp4");
const final = join(outDir, "MUNCAS_LETRAS_FINAL_V4.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasLetras", raw,
    `--crf=${crf}`,
