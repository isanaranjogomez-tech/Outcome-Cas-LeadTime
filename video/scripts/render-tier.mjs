 ...
 *
 *   node scripts/render-tier.mjs
 *   node scripts/render-tier.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_TIER_FINAL.raw.mp4");
const final = join(outDir, "MUNCAS_TIER_FINAL.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasTier", raw,
    `--crf=${crf}`,
