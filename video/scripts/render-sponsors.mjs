#!/usr/bin/env node
/**
 * Renders the MUNCAS sponsors piece and masters its audio for social.
 *
 *   node scripts/render-sponsors.mjs
 *   node scripts/render-sponsors.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_SPONSORS_FINAL.raw.mp4");
const final = join(outDir, "MUNCAS_SPONSORS_FINAL.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasSponsors", raw,
    `--crf=${crf}`,
