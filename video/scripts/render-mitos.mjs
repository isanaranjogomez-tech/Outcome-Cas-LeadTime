#!/usr/bin/env node
/**
 * Renders the MUNCAS myths reel and masters its audio for social.
 *
 *   node scripts/render-mitos.mjs
 *   node scripts/render-mitos.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_MITOS_FINAL.raw.mp4");
const final = join(outDir, "MUNCAS_MITOS_FINAL.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasMitos", raw,
    `--crf=${crf}`,
