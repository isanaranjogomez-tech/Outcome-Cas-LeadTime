 ...
 *
 *   node scripts/render-plata.mjs
 *   node scripts/render-plata.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_PLATA_FINAL.raw.mp4");
const final = join(outDir, "MUNCAS_PLATA_FINAL.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasPlata", raw,
    `--crf=${crf}`,
