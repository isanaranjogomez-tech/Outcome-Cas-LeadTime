 ...
 *
 *   node scripts/render-palabras.mjs
 *   node scripts/render-palabras.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_PALABRAS_FINAL.raw.mp4");
const final = join(outDir, "MUNCAS_PALABRAS_FINAL.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasPalabras", raw,
    `--crf=${crf}`,
