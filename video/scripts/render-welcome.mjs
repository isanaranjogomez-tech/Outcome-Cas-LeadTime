#!/usr/bin/env node
/**
 * Renders the Welcome MUNCAS reel and masters its audio for social.
 *
 *   node scripts/render-welcome.mjs
 *   node scripts/render-welcome.mjs --quality        # bigger file, crf 16
 *
...
const raw = join(outDir, "MUNCAS_WELCOME_FINAL.raw.mp4");
const final = join(outDir, "MUNCAS_WELCOME_FINAL.mp4");
...
const render = run(
  "npx",
  [
    "remotion", "render", "MuncasWelcome", raw,
    `--crf=${crf}`,
